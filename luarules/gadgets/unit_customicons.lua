...
local icons = {
  ...
  {"mine1.user", "icons/square.png",0.36*iconScale},
  {"mine2.user", "icons/square.png",0.44*iconScale},
  {"mine3.user", "icons/square.png",0.53*iconScale},

  {"sub_t1.user", "icons/tri-down.png",1.33*iconScale},
  {"sub_t2.user", "icons/tri-down.png",1.7*iconScale},
  {"sub_t1_worker.user", "icons/tri-down.png",1.33*iconScale},
  {"sub_t2_worker.user", "icons/tri-down.png",1.66*iconScale},


  {"wind.user", "icons/e.png",1.0*iconScale},
  {"energy1.user", "icons/e.png",1.0*iconScale},   
  {"energy2.user", "icons/e.png",1.0*iconScale},
  {"energy3.user", "icons/e.png",2.0*iconScale},
  {"energy4.user", "icons/e.png",3.0*iconScale},
  {"energy5.user", "icons/e.png",3.0*iconScale},
  {"energy6.user", "icons/e.png",1.5*iconScale},

  {"eye.user", "icons/square.png",0.85*iconScale},
  {"spy.user", "icons/ba_sphere.png",1.25*iconScale},

  {"hover_t1.user", "icons/sphere.png",0.9*iconScale},
  {"hover_t1_worker.user", "icons/cross.png",0.9*iconScale},
  {"hover_t1_aa.user", "icons/sphere.png",0.9*iconScale},
  {"hover_t2.user", "icons/sphere.png",1.3*iconScale},
  {"hover_t3.user", "icons/sphere.png",1.6*iconScale},

  {"ship_tiny.user", "icons/tri-down.png",0.8*iconScale},
  {"ship.user", "icons/tri-down.png",1.2*iconScale},
  {"ship_destroyer.user", "icons/tri-down.png",1.44*iconScale},
  {"ship_t1_worker.user", "icons/cross.png",1.33*iconScale},
  {"ship_aa1.user", "icons/tri-down.png",1.2*iconScale},
  {"ship_t2.user", "icons/tri-down.png",1.65*iconScale},
  {"ship_t2_worker.user", "icons/tri-down.png",1.65*iconScale},
  {"ship_t2_aa1.user", "icons/tri-down.png",1.65*iconScale},
  {"ship_t2_big.user", "icons/tri-down.png",2*iconScale},
  {"ship_t2_battleship.user", "icons/tri-down.png",2.5*iconScale},
  {"ship_t2_battleship.user", "icons/tri-down.png",2.5*iconScale},
  {"ship_t2_flagship.user", "icons/tri-down.png",3.3*iconScale},

  {"amphib_t1.user", "icons/tri-down.png",1.2*iconScale},
  {"amphib_t1_aa.user", "icons/tri-down.png",1.2*iconScale},
  {"amphib_t1_worker.user", "icons/cross.png",1.3*iconScale},
  {"amphib_t2.user", "icons/tri-down.png",1.6*iconScale},
  {"amphib_t2_aa.user", "icons/tri-down.png",1.6*iconScale},
  {"amphib_t3.user", "icons/tri-down.png",2.05*iconScale},

  {"shield.user", "icons/hemi.png", 2.05*iconScale},

  {"radar_t1.user", "icons/diamond.png", 0.9*iconScale},
  {"jammer_t1.user", "icons/diamond.png", 0.9*iconScale},
  {"radar_t2.user", "icons/diamond.png", 1.2*iconScale},
  {"jammer_t2.user", "icons/diamond.png", 1.2*iconScale},

  {"krogoth.user", "icons/sphere.png",3.2*iconScale},
  {"bantha.user", "icons/sphere.png",2.6*iconScale},
  {"juggernaut.user", "icons/sphere.png",2.75*iconScale},
  {"commando.user", "icons/sphere.png",1.3*iconScale},

  {"mex_t1.user", "icons/m.png",0.85*iconScale},
  {"mex_t2.user", "icons/m.png",1.15*iconScale},

  {"metalmaker_t1.user", "icons/m.png",0.75*iconScale},
  {"metalmaker_t2.user", "icons/m.png",1.15*iconScale},
  ...
  {"aa1.user", "icons/x.png", 0.85*iconScale},
  {"aa2.user", "icons/x.png", 1.1*iconScale},
  {"aa_flak.user", "icons/x.png", 1.4*iconScale},
  {"aa_longrangenergy1.user", "icons/x.png", 1.8*iconScale},

  {"worker.user", "icons/cross.png", 0.85*iconScale},

  {"allterrain_t1.user", "icons/sphere.png",1*iconScale},
  {"allterrain_t2.user", "icons/sphere.png",1.33*iconScale},
  {"allterrain_t3.user", "icons/sphere.png",1.95*iconScale},
  {"allterrain_vanguard.user", "icons/sphere.png",2.3*iconScale},

  {"kbot_t1_flea.user", "icons/sphere.png",0.51*iconScale},
  {"kbot_t1_tinyworker.user", "icons/cross.png",0.8*iconScale},
  {"engineer.user", "icons/cross.png",1.4*iconScale},
  {"ship_engineer.user", "icons/cross.png",1.5*iconScale},
  {"kbot_t1_raid.user", "icons/sphere.png",0.7*iconScale},
  {"kbot_t1.user", "icons/sphere.png",0.95*iconScale},
  {"kbot_t1_big.user", "icons/sphere.png",1.1*iconScale},
  {"kbot_t1_worker.user", "icons/cross.png",0.95*iconScale},
  {"kbot_t1_aa1.user", "icons/sphere.png",0.95*iconScale},
  {"kbot_t2.user", "icons/sphere.png",1.28*iconScale},
  {"kbot_t2_big.user", "icons/sphere.png",1.47*iconScale},
  {"kbot_t2_worker.user", "icons/cross.png", 1.33*iconScale},
  {"kbot_t2_aa1.user", "icons/sphere.png",1.28*iconScale},
  {"kbot_t3.user", "icons/sphere.png",1.9*iconScale},

  {"tank_t1_flea.user", "icons/sphere.png",0.55*iconScale},
  {"tank_t1_raid.user", "icons/sphere.png",0.75*iconScale},
  {"tank_t1.user", "icons/sphere.png",1*iconScale},
  {"tank_t1_big.user", "icons/sphere.png",1.15*iconScale},
  {"tank_t1_aa1.user", "icons/sphere.png",1*iconScale},
  {"tank_t2.user", "icons/sphere.png",1.3*iconScale},
  {"tank_t2_aa1.user", "icons/sphere.png",1.3*iconScale},
  {"tank_t2_big.user", "icons/sphere.png",1.5*iconScale},
  {"tank_t1_worker.user", "icons/cross.png",0.95*iconScale},
  {"tank_t2_worker.user", "icons/cross.png", 1.3*iconScale},

  {"building_t1.user", "icons/square.png", 1*iconScale},
  {"building_t2.user", "icons/square.png", 1.3*iconScale},

  {"factory_t1", "icons/square.png",1.45*iconScale},
  {"factory_t2", "icons/square.png",1.85*iconScale},
  {"factory_t3", "icons/square.png",2.4*iconScale},

  {"lrpc.user", "icons/sphere.png", 2.35*iconScale},
  {"lrpc_lolcannon.user", "icons/sphere.png", 3.5*iconScale},

  {"chicken_queen.user", "icons/queen.png", 4*iconScale},

  {"meteor.user", "icons/meteor.png", 1*iconScale},

  {"wall.user", "icons/square.png",0.55*iconScale},

  {"air_t1.user", "icons/tri-up.png",0.85*iconScale},
  {"air_t1_worker.user", "icons/cross.png",1.2*iconScale},
  {"air_t1_hover_t1.user", "icons/tri-up.png",1.25*iconScale},
  {"air_t1_bomber.user", "icons/tri-up.png",1.35*iconScale},
  {"air_t1_transport.user", "icons/tri-up.png",1.3*iconScale},
  {"air_t1_scout.user", "icons/tri-up.png",0.6*iconScale},
  {"air_t2.user", "icons/tri-up.png",1.05*iconScale},
  {"air_t2_worker.user", "icons/cross.png",1.6*iconScale},
  {"air_t2_hover_t1.user", "icons/tri-up.png",1.55*iconScale},
  {"air_t2_bomber.user", "icons/tri-up.png",1.66*iconScale},
  {"air_t2_transport.user", "icons/tri-up.png",1.6*iconScale},
  {"veh_transport.user", "icons/sphere.png",1.7*iconScale},
  {"hover_transport.user", "icons/sphere.png",1.5*iconScale},
  {"ship_transport.user", "icons/sphere.png",2*iconScale},
  {"air_t2_radar_t1.user", "icons/tri-up.png",1.33*iconScale},
  {"air_bladew.user", "icons/tri-up.png",0.75*iconScale},
  {"air_krow.user", "icons/tri-up.png",2*iconScale},
  {"air_liche.user", "icons/tri-up.png",2*iconScale},

  {"defence_0", "icons/x.png", 0.8*iconScale},
  {"defence_1", "icons/x.png", 1.05*iconScale},
  {"defence_2", "icons/x.png", 1.4*iconScale},
  {"defence_3", "icons/x.png", 1.95*iconScale},
